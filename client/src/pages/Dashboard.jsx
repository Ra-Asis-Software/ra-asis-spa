...
import Units from "../components/dashboard/shared/Units.jsx";
import ProfileContent from "../components/dashboard/shared/ProfileContent.jsx";
...
const Dashboard = () => {
  ...
  const persistSelectedUnit = () => {
    ...
    setSelectedUnit(
      storedUnit
        ? JSON.parse(storedUnit)
        : units.length > 0
        ? units[0]
        : { name: "All Units", id: "all" }
    );
  };
