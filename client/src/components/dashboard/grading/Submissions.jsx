...
const Submissions = () => {
  ...
  const [questions] = useState([
    ...
    {
      id: 3,
      question: "Explain the chain rule in calculus with an example.",
      maxMarks: 30,
    },
    {
      id: 4,
  ...
  const [students] = useState([
    {
      ...
      answers: [
        {
          questionId: 1,
          answer: "The derivative of x² + 3x + 2 is 2x + 3",
          marks: 18,
        },
        { questionId: 2, answer: "x = 1.5 or x = 1", marks: 20 },
        {
          questionId: 3,
          answer: "Chain rule explained with example",
          marks: 25,
        },
    ...
    },
    {
      ...
      answers: [
        ...
        {
          questionId: 3,
          answer: "Chain rule with sin(x²) example",
          marks: null,
        },
        {
          questionId: 4,
          answer: "Integral of x² from 0 to 3 equals 9",
          marks: null,
        },
      ],
    },
